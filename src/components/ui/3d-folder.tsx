    ...
    <>
      ...
      >
        ...
        >
          ...
          <p className="text-sm text-accent font-medium">{position}</p>
        ...
        {/* Project count */}
        <p
          className="text-sm text-muted-foreground transition-all duration-300 mt-2"
          style={{
            opacity: isHovered ? 0.7 : 1,
          }}
        >
          {projects.length} {projectsText}
        </p>
